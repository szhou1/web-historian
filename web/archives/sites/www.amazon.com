...
<div class="a-container a-padding-double-large" style="min-width:350px;padding:44px 0 !important">
    ...
    <div class="a-row a-spacing-double-large" style="width: 350px; margin: 0 auto">
                ...
                <div class="a-box a-color-offset-background">
                    <div class="a-box-inner a-padding-extra-large">
                        ...
                        <form method="get" action="/errors/validateCaptcha" name="">
                            <input type=hidden name="amzn" value="/YGmLUXByrqX7S3SIZqscQ==" /><input type=hidden name="amzn-r" value="&#047;" /><input type=hidden name="amzn-pt" value="Gateway" />
                            <div class="a-row a-spacing-large">
                                <div class="a-box">
                                    <div class="a-box-inner">
                                        <h4>Type the characters you see in this image:</h4>
                                        <div class="a-row a-text-center">
                                            <img src="http://ecx.images-amazon.com/captcha/sargzmyv/Captcha_zjocsdtmzp.jpg">
                                        </div>
        ...
        <div class="a-text-center a-size-mini a-color-secondary">
          ...
          <script>
           if (true === true) {
             document.write('<img src="http://fls-na.amaz'+'on.com/'+'1/oc-csi/1/OP/requestId=0R6PJ0VVA5QYDSZ2MFTQ&js=1" />');
           };
          </script>
          <noscript>
            <img src="http://fls-na.amazon.com/1/oc-csi/1/OP/requestId=0R6PJ0VVA5QYDSZ2MFTQ&js=0" />
          </noscript>
        </div>
    </div>
    <script>
